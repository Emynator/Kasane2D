...
/// <summary>
/// An update for ping pong delay parameters.
/// </summary>
...
/// <param name="Delay">Optional: changes the delay time of the delay.</param>
/// <param name="DecayGain">Optional: changes the decay gain of the delay.</param>
...
public sealed record class PingPongDelayUpdate
    (
    string EffectName,
    bool? Bypass = null,
